...
export default function MonolithLoader() {
    ...
    const logoSrc = resolvedTheme === "dark" ? "/logos/logo-white.png" : "/logos/logo-black.png";
                ...
                >
                    ...
                    <div className="relative w-72 h-24 md:w-125 md:h-32">
                        ...
                        <motion.div
                            ...
                            className="absolute inset-0"
                        >
                            <Image src={logoSrc} alt="SCARABIX" fill sizes="(max-width: 768px) 288px, 500px" className="object-contain" priority />
                        </motion.div>
                    </div>
                </motion.div>
            )}
